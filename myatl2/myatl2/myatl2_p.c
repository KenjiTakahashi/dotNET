...
typedef struct _myatl2_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } myatl2_MIDL_TYPE_FORMAT_STRING;

typedef struct _myatl2_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } myatl2_MIDL_PROC_FORMAT_STRING;

typedef struct _myatl2_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } myatl2_MIDL_EXPR_FORMAT_STRING;
...
extern const myatl2_MIDL_TYPE_FORMAT_STRING myatl2__MIDL_TypeFormatString;
extern const myatl2_MIDL_PROC_FORMAT_STRING myatl2__MIDL_ProcFormatString;
extern const myatl2_MIDL_EXPR_FORMAT_STRING myatl2__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IPrimeTester_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IPrimeTester_ProxyInfo;
...
static const myatl2_MIDL_PROC_FORMAT_STRING myatl2__MIDL_ProcFormatString =
    {
        0,
        {
...
static const myatl2_MIDL_TYPE_FORMAT_STRING myatl2__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    myatl2__MIDL_ProcFormatString.Format,
...
/* Object interface: IPrimeTester, ver. 0.0,
   GUID={0x5B91A23D,0x8FC0,0x457F,{0xB3,0x06,0x75,0x60,0x01,0x95,0x0F,0x95}} */

#pragma code_seg(".orpc")
static const unsigned short IPrimeTester_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IPrimeTester_ProxyInfo =
    {
    &Object_StubDesc,
    myatl2__MIDL_ProcFormatString.Format,
    &IPrimeTester_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IPrimeTester_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    myatl2__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IPrimeTesterProxyVtbl = 
{
    &IPrimeTester_ProxyInfo,
    &IID_IPrimeTester,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IPrimeTester::IsPrime */ ,
    (void *) (INT_PTR) -1 /* IPrimeTester::IsPrime2 */
};


static const PRPC_STUB_FUNCTION IPrimeTester_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IPrimeTesterStubVtbl =
{
    &IID_IPrimeTester,
    &IPrimeTester_ServerInfo,
    9,
    &IPrimeTester_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    myatl2__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _myatl2_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IPrimeTesterProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _myatl2_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IPrimeTesterStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _myatl2_InterfaceNamesList[] = 
{
    "IPrimeTester",
    "IComponentRegistrar",
    0
...
const IID *  const _myatl2_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _myatl2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _myatl2, pIID, n)

int __stdcall _myatl2_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _myatl2, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _myatl2, 2, *pIndex )
    
}

const ExtendedProxyFileInfo myatl2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _myatl2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _myatl2_StubVtblList,
    (const PCInterfaceName * ) & _myatl2_InterfaceNamesList,
    (const IID ** ) & _myatl2_BaseIIDList,
    & _myatl2_IID_Lookup, 
    2,
    2,
