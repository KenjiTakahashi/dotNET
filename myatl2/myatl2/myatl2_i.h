...
#ifndef __myatl2_i_h__
#define __myatl2_i_h__
...
#ifndef __IPrimeTester_FWD_DEFINED__
#define __IPrimeTester_FWD_DEFINED__
typedef interface IPrimeTester IPrimeTester;
#endif 	/* __IPrimeTester_FWD_DEFINED__ */
...
#ifndef __PrimeTester_FWD_DEFINED__
#define __PrimeTester_FWD_DEFINED__

#ifdef __cplusplus
typedef class PrimeTester PrimeTester;
#else
typedef struct PrimeTester PrimeTester;
#endif /* __cplusplus */

#endif 	/* __PrimeTester_FWD_DEFINED__ */
...
#ifndef __IPrimeTester_INTERFACE_DEFINED__
#define __IPrimeTester_INTERFACE_DEFINED__

/* interface IPrimeTester */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IPrimeTester;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("5B91A23D-8FC0-457F-B306-756001950F95")
    IPrimeTester : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE IsPrime( 
            /* [in] */ int number,
            /* [retval][out] */ int *state) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE IsPrime2( 
            /* [in] */ int number,
            /* [retval][out] */ int *state) = 0;
    ...
    typedef struct IPrimeTesterVtbl
    {
        BEGIN_INTERFACE
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *IsPrime )( 
            IPrimeTester * This,
            /* [in] */ int number,
            /* [retval][out] */ int *state);
        
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *IsPrime2 )( 
            IPrimeTester * This,
            /* [in] */ int number,
            /* [retval][out] */ int *state);
    ...
    interface IPrimeTester
    {
        CONST_VTBL struct IPrimeTesterVtbl *lpVtbl;
    };
...
#define IPrimeTester_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IPrimeTester_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IPrimeTester_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IPrimeTester_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IPrimeTester_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IPrimeTester_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IPrimeTester_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IPrimeTester_IsPrime(This,number,state)	\
    ( (This)->lpVtbl -> IsPrime(This,number,state) ) 

#define IPrimeTester_IsPrime2(This,number,state)	\
    ( (This)->lpVtbl -> IsPrime2(This,number,state) ) 
...
#endif 	/* __IPrimeTester_INTERFACE_DEFINED__ */



#ifndef __myatl2Lib_LIBRARY_DEFINED__
#define __myatl2Lib_LIBRARY_DEFINED__

/* library myatl2Lib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_myatl2Lib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("DA3A4375-8F8B-4B82-943D-725A889B0559")
CompReg;
#endif

EXTERN_C const CLSID CLSID_PrimeTester;

#ifdef __cplusplus

class DECLSPEC_UUID("23FF20E7-F37C-4E68-8BBC-864E7A4F9B59")
PrimeTester;
#endif
#endif /* __myatl2Lib_LIBRARY_DEFINED__ */
